...
class ScannedRecipeWidget extends StatefulWidget {
  ...
  @override
  State<ScannedRecipeWidget> createState() => _NewScannedRecipeWidgetState();
}
  
class _NewScannedRecipeWidgetState extends State<ScannedRecipeWidget> {
  @override
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                ShowScannedRecipe(recipeModel: widget.recipeModel),
          ),
        );
      },
      child: Card(
